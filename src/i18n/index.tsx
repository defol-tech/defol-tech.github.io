...
const translations = {
  pt: {
    ...
    'incubator.title': 'Incubadora de Projetos Defol',
    'incubator.subtitle': 'Transforme sua necessidade em um ativo digital lucrativo. Buscamos nichos esquecidos para criar soluções de coparticipação.',
    'incubator.card1.title': 'Diluição de Custos',
    'incubator.card1.desc': 'Custos de desenvolvimento e manutenção compartilhados, tornando o produto viável para pequenas empresas.',
    'incubator.card2.title': 'Participação nos Lucros',
    'incubator.card2.desc': 'Além de usar a solução, você ganha com a venda do software para outras empresas do seu segmento.',
    'incubator.card3.title': 'Escala Exponencial',
    'incubator.card3.desc': 'Um Plano B para seu negócio: uma fonte de renda digital, sem limites geográficos ou físicos.',
    'incubator.cta': 'Seja nosso parceiro',
  ...
  en: {
    ...
    'incubator.title': 'Defol Project Incubator',
    'incubator.subtitle': 'Transform your need into a profitable digital asset. We seek forgotten niches to create coparticipation solutions.',
    'incubator.card1.title': 'Cost Dilution',
    'incubator.card1.desc': 'Development and maintenance costs shared, making the product viable for small companies.',
    'incubator.card2.title': 'Profit Sharing',
    'incubator.card2.desc': 'In addition to using the solution, you profit from selling the software to other companies in your segment.',
    'incubator.card3.title': 'Exponential Scale',
    'incubator.card3.desc': 'A Plan B for your business: a digital revenue stream, without geographical or physical limits.',
    'incubator.cta': 'Be our partner',
